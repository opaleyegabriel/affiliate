...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Log In | Affiliate Marketing - Sell Land Remotely</title>
      <!-- Favicon -->
  ...
  <body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <style media="screen">
                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           ...
                           <p class="text-center">DreamcityHES Affiliate Market</p>
                           <div>
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       <!-- <label for="mobile" class="form-label">Phone Number</label> -->
                                       <input type="number" class="form-control" id="mobile" name="mobile" aria-describedby="mobile" required placeholder="Enter Phone Number " maxlength="11">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="password" class="form-control" id="password" name="password" aria-describedby="password" required placeholder="Enter Your Password ">
                                       <div class="text-danger fs-7" id="passworderr">
                                 ...
                                 <div class="col-lg-12" >
                                    ...
                                    <a href="<?php echo URL ?>forgotpassword" style="float:right;">Forgot Password?</a>
                                 </div>
                              </div>
                              ...
                              <p class="mt-3 text-center">
                                 Don’t have an account? <a href="<?php echo URL; ?>register" class="text-underline">Sign up.</a>
                              </p>
                           </div>
                        </div>
                     </div>
      ...
      <script>
              ...
              <div class="swal-overlay swal-overlay--show-modal" tabindex="-1" style="display:none" id="confirmation">
              ...
              </div><div class="swal-title" style="">Authenticating!</div><div class="swal-text" style="">Redirecting Plese Wait</div><div class="swal-footer"><div class="swal-button-container">
    ...
    <script src="<?php echo URL; ?>public/assets/js/sweetalert/sweetalert.min.js"></script>
